const apiKey = "bb426868eafd1d5915a1c3a6f53a44bf";
...
const cityName=prompt("What city's weather do you want to know about?")

const fetchWeather=(cityName)=>{
   return new Promise( async(resolve, reject)=>{
      const res=await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&units=imperial&appid=${apiKey}`)
...
.then(data=>{
   ...
   document.querySelector("#weather-info").innerText=`City: ${cityName} \n Temperature: ${temperature} \n Weather: ${description}`
})
